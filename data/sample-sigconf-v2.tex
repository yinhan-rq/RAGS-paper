...
multiple inference calls into structured, multi-step execution graphs~\cite{yao2022react}. As these 
...
infrastructure has emerged as a critical bottleneck~\cite{kwon2023efficient,yu2022orca}. In this context, the 
...
features, we introduce a Transformer-based scheduling network that
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.8\linewidth]{../figures/5.6.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\linewidth]{../figures/5.7.pdf}
